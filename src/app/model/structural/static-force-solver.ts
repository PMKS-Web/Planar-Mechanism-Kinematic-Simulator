...
/** Pure single-pose rigid-body statics. It neither solves positions nor modifies its inputs. */
export function analyzeStatic(
  ...
  try {
    return solveEquilibrium(A, b, configuration, origins, reactions, driverStart, diagnostics);
  } catch {
...
function validateConfiguration(c: StructuralConfiguration): StaticForceAnalysisResult | undefined {
