...
export const SUITES = [
  ...
  {
    name: 'ghost-is-the-start',
    seconds: 72,
    lanes: BOTH,
    note: 'Its seeds and step counts are fixed, so it is a check rather than a lottery; the wider sweep it was shrunk from is a scratch script, not this.',
  },
  {
  ...
  { name: 'playback-direction', seconds: 18, lanes: BOTH },
  {
