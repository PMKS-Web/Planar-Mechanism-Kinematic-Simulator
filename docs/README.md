...
- [structural-analysis.md](structural-analysis.md) — S0 metadata, S1 static equilibrium, and S2 inverse dynamics: audits, SI snapshots, supported topology, diagnostics, and validation. *Built*
