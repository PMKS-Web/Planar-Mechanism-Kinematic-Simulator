...
- [what-is-this-shipping.md](what-is-this-shipping.md) — how “What is this?” reaches students: its section in the per-machine panel, the picture taken from the canvas, the Netlify Function that holds the Gemini key, caching, rate limits, running it locally, and the library's notes written at release time. *Current*
