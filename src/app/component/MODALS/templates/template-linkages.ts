...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  ...
  Cylinder_Gripper:
    '2v.Ay,6G.5,0.1011.4A,A,01E8,0,0.0B,B,0w9,0,0.8C,C,0vV,0,0.0D,D,0bW,0,0.0G,G,0Fe,Fe,0.0H,H,Fe,Fe,0.0I,I,0Fe,0Fe,0.0J,J,Fe,0Fe,0.4K,K,0T4,xO,0.4L,L,0T4,0xO,0.4O,O,2C,xO,0.4P,P,2C,0xO,0.0M,M,0T4,XI,0.0Q,Q,2C,XI,0.0S,S,11U,Dc,0.0T,T,0T4,0XI,0.0V,V,2C,0XI,0.0X,X,11U,0Dc,0.ZE,E,0vV,0,0,AB,A,B.1N,N,0T4,XI,0,KL,K,L.1R,R,2C,XI,0,OP,O,P.1U,U,0T4,0XI,0,KL,K,L.1W,W,2C,0XI,0,OP,O,P..YRAB,Barrel,0,0,0148,0,303e9f,A,B,,.YRCD,Rod,0,0,0lW,0,26A69A,C,D,,.YRDGHIJ,Carriage,0,0,07W,0,00695C,D,G,H,I,J,,.YRKL,Rail,0,0,0T4,0,0d125a,K,L,,.YROP,Rail,0,0,2C,0,0d125a,O,P,,.YRGM,GM,0,0,0MM,OT,26A69A,G,M,,.YRHQ,HQ,0,0,8w,OT,26A69A,H,Q,,.YRMQS,Jaw,0,0,Ct,Qk,00695C,M,Q,S,,.YRIT,IT,0,0,0MM,0OT,26A69A,I,T,,.YRJV,JV,0,0,8w,0OT,26A69A,J,V,,.YRTVX,Jaw,0,0,Ct,0Qk,00695C,T,V,X,,.YPCE,CE,0,0,0,0,,C,E,,.YPMN,MN,0,0,0,0,,M,N,,.YPQR,QR,0,0,0,0,,Q,R,,.YPTU,TU,0,0,0,0,,T,U,,.YPVW,VW,0,0,0,0,,V,W,,...N_2*44g3NM',
  Radial_Engine:
