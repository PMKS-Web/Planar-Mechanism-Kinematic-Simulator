...
| S7 | **Dragging S** is Starts at by hand: S follows the pointer along the axis between the stops, with D11's tiebreak deciding what gives. Typing its X or Y does the same through the same door. |
