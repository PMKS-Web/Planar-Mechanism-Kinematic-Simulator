...
- `matlab-package.mjs` — actual app export of an independent MATLAB analysis ZIP, readable equations/named results, force options, optional reference data, phone layout, unsupported-driver refusal and kinematics-only omission of force files. Uses configured four-bar masses/inertias; artifacts include the extracted package and screenshots.
