...
- [structural-analysis.md](structural-analysis.md) — S0 metadata, S1 static equilibrium, S2 inverse dynamics, and S3 internal member loads: geometry audits, SI snapshots, cut conventions, mass distributions, diagnostics, and validation. *Built*
