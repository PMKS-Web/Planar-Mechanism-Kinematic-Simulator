...
export const SUITES = [
  ...
  { name: 'force-analysis-panels', seconds: 23, lanes: BOTH },
  ...
  { name: 'left-nav-modes', seconds: 18, lanes: BOTH },
  ...
  { name: 'phase2-floating-slot', seconds: 7, lanes: BOTH },
  { name: 'phase3-slide', seconds: 8, lanes: BOTH },
  ...
  { name: 'playback-timing', seconds: 24, lanes: BOTH },
  {
