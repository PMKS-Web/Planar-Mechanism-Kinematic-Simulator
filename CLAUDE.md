...
The staging-based integration branch is `feature/gears`; its ancestry and final verification
are recorded in [gears-integration.md](docs/gears-integration.md).
