...
- [joint-type-and-cylinder-plan.md](joint-type-and-cylinder-plan.md) — plan of record: joint type as one four-way choice, a slider as one joint, a cylinder as a sealed slide; retires the bodies-and-joints migration. Stage 0, the choice itself, is built. *Partly built*
