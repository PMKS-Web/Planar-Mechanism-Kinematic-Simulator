...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  ...
  Drag_Link:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.0B,B,0,YO,0.0C,C,cU,LL,0.4D,D,Fe,0,0..YRAB,AB,0,0,0,HC,303e9f,A,B,,.YRBC,BC,0,0,JF,Rs,26A69A,B,C,,.YRCD,CD,0,0,R3,Ag,0d125a,C,D,,...N_e*2U0Jdj',
  Bell_Crank:
  ...
  Locked_Four_Bar:
    '2v.Ay,1E8.5,0.1011.6A,A,0,0,0.0B,B,Nm,0,0.0C,C,126,lL,0.4D,D,17S,0,0.0E,E,1As,PW,0.0F,F,dq,Uc,0.0G,G,W5,tN,0.0H,H,Bu,G4,0.0I,I,11K,UW,0..YRABH,ABH,0,0,01Zi,bM,303e9f,A,B,H,,.YRBCFG,BCFG,0,0,jM2,p3C,26A69A,B,C,F,G,,.YRCDEI,CDEI,0,0,1pNm,0550,0d125a,C,D,E,I,,...N_.JB,JC,JD,JE,JF,JG,JIZ*01UkIe',
  Three_Machines:
