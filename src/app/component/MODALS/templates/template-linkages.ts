...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  ...
  Cylinder_Gripper:
    '2P.Ay,3w.5,0.1011.4A,A,019C,Bh,0.0B,B,01H,Bg,0.8C,C,0Qb,Bg,0.0D,D,jM,Bf,0.0G,G,13N,ky,0.0H,H,20s,ky,0.0I,I,13N,0Fp,0.0J,J,20s,0Fp,0.4K,K,0,2NW,0.4L,L,1Q,01pB,0.0M,M,K,1SF,0.4O,O,1bt,2Q6,0.4P,P,1eQ,02Tv,0.0Q,Q,1cO,1QQ,0.0S,S,3e3,13W,0.0T,T,16,0tr,0.0V,V,1dc,0w4,0.0X,X,3e3,0Yl,0.ZE,E,0Qb,Bg,0,AB,A,B.1N,N,K,1SF,0,KL,K,L.1R,R,1cO,1QQ,0,OP,O,P.1U,U,16,0tr,0,KL,K,L.1W,W,1dc,0w4,0,OP,O,P..YRAB,AB,0,0,0bE,Bg,303e9f,A,B,,.YRCD,CD,0,0,9O,Bg,26A69A,C,D,,.YRDGHIJ,DGHIJ,0,0,1NZ,Eo,00695C,D,G,H,I,J,,.YRKL,KL,0,0,j,IA,0d125a,K,L,,.YRGM,GM,0,0,Xr,15c,26A69A,G,M,,.YROP,OP,0,0,1d9,01w,0d125a,O,P,,.YRHQ,HQ,0,0,1pd,14h,26A69A,H,Q,,.YRMQS,MQS,0,0,1lb,1JO,00695C,M,Q,S,,.YRIT,IT,0,0,YF,0Zq,26A69A,I,T,,.YRJV,JV,0,0,1qE,0ax,26A69A,J,V,,.YRTVX,TVX,0,0,1mG,0nZ,00695C,T,V,X,,.YPCE,CE,0,0,0,0,,C,E,,.YPMN,MN,0,0,0,0,,M,N,,.YPQR,QR,0,0,0,0,,Q,R,,.YPTU,TU,0,0,0,0,,T,U,,.YPVW,VW,0,0,0,0,,V,W,,...N_A',
  Radial_Engine:
  ...
  Four_Bar_Inversions:
    '2P.Ay,1E8.5,0.1011.6A,A,0,1Tm,0,,,,2SG.0B,B,05R,1yY,0.0C,C,fR,1x5,0.4D,D,Fe,1Tm,0.6E,E,2Ce,1Tm,0,,,,2SG.0F,F,2KS,1hI,0.0G,G,2ey,2CY,0.4H,H,2hu,1Tm,0.6I,I,0,0,0,,,,2SG.0J,J,Hx,Pc,0.0K,K,UB,ZK,0.4L,L,ku,0,0.6M,M,2Ce,0,0,,,,2SG.0N,N,2KS,DY,0.0O,O,2W2,gZ,0.4P,P,2pi,0,0..YRAB,L2,0,0,02k,1j9,26A69A,A,B,,.YRBC,L3,0,0,I0,1xp,0d125a,B,C,,.YRCD,L4,0,0,SY,1iR,00695C,C,D,,.YREF,L1,0,0,2GY,1aX,303e9f,E,F,,.YRFG,L4,0,0,2Ui,1xw,00695C,F,G,,.YRGH,L3,0,0,2gQ,1r9,0d125a,G,H,,.YRIJ,L2,0,0,8_,Cp,26A69A,I,J,,.YRJK,L1,0,0,O3,UT,303e9f,J,K,,.YRKL,L4,0,0,cX,Hg,00695C,K,L,,.YRMN,L1,0,0,2GY,6n,303e9f,M,N,,.YRNO,L2,0,0,2QF,S3,26A69A,N,O,,.YROP,L3,0,0,2ft,LI,0d125a,O,P,,...N_a',
  // </generated>
};
