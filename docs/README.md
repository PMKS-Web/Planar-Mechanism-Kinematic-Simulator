...
- [friction-design.md](friction-design.md) — prescribed-motion slider and pin friction, local static limits, supported contacts, and deferred sticking/stalling simulation. *Partly built*
