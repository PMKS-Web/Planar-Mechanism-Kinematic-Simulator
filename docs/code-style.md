...
half of every search. `e2e/ui-copy.mjs` fails the build on British forms in user-facing text; the
full word list is in [tips and tricks](tips-and-tricks.md#spelling-american-everywhere).
