...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  ...
  Elliptical_Crank:
    '2v.Ay,1E8.A,0.1011.6A,A,0ix,X,0.0B,B,0zu,7O,0.0C,C,0qC,Lr,0.GD,D,085,Av,0.0E,E,aY,v,0.4F,F,0,0,0.5P,P,aY,v,03..YRAB,AB,0,0,0rQ,3y,303e9f,A,B,,.YRBC,BC,0,0,0v2,Ed,26A69A,B,C,,.YRCDE,CDE,0,0,07x,BD,00695C,C,D,E,,.YRDF,DF,0,0,043,5S,0d125a,D,F,,.YPEP,EP,0,0,0,0,,E,P,,...N_M*3Z168f',
  Jansen_Leg:
