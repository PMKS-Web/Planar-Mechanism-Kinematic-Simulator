...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  '4-Bar':
    '2v.Fe,1E8.A,0.1011.6A,A,0mv,0VU,0.0B,B,0e_,E6,0.0C,C,l1,WW,0.4D,D,qD,0Pk,0..YRAB,AB,0,0,0ix,08i,303e9f,A,B,,.YRBC,BC,0,0,32,NJ,26A69A,B,C,,.YRCD,CD,0,0,nd,3P,0d125a,C,D,,...N_p',
  Watt_I:
    '2v.Fe,1E8.A,0.1011.6A,A,0Qh,0Kn,0.0B,B,0e1,9i,0.0C,C,bT,LF,0.0D,D,0G5,tZ,0.0E,E,V5,1_z,0.0F,F,1mM,1Gv,0.4G,G,1rt,0ey,0..YRAB,AB,0,0,0XM,05Z,303e9f,A,B,,.YRBCD,BCD,0,0,06D,Sr,26A69A,B,C,D,,.YRDE,DE,0,0,7W,1RG,00695C,D,E,,.YREF,EF,0,0,17j,1dx,26A69A,E,F,,.YRFCG,FCG,0,0,1PE,KQ,0d125a,F,C,G,,...N_k',
  Watt_II:
    '2v.Fe,1E8.A,0.1011.6A,A,0Vf,0Vd,0.0B,B,0mZ,08A,0.0C,C,06Y,LC,0.0D,D,1MR,J2,0.4E,E,rw,0j2,0.0F,F,2ic,ID,0.4G,G,2lk,0Zt,0..YRAB,AB,0,0,0e6,0Ju,303e9f,A,B,,.YRBC,BC,0,0,0RY,6X,26A69A,B,C,,.YRCDE,CDE,0,0,ic,01d,0d125a,C,D,E,,.YRDF,DF,0,0,21X,Id,00695C,D,F,,.YRFG,FG,0,0,2kA,08r,303e9f,F,G,,...N_h',
  Stephenson_III:
    '2v.Fe,1E8.A,0.1011.6A,A,0YP,0ce,0.0B,B,0cQ,0FI,0.0C,C,lC,1-,0.4D,D,ow,0U1,0.0E,E,033,D-,0.0F,F,Dc,nj,0.4G,G,1M0,GJ,0..YRAB,AB,0,0,0aP,0Qz,303e9f,A,B,,.YRBCE,BCE,0,0,1w,E,26A69A,B,C,E,,.YRCD,CD,0,0,n3,0E1,0d125a,C,D,,.YREF,EF,0,0,5H,Vs,00695C,E,F,,.YRFG,FG,0,0,np,X0,303e9f,F,G,,...N_Z',
  Slider_Crank:
    '2v.Fe,1E8.A,0.1011.6A,A,0mA,0c,0.0B,B,0Yt,bK,0.0C,C,il,H-,0.5D,D,il,H-,0..YRAB,AB,0,0,0fW,IN,303e9f,A,B,,.YRBC,BC,0,0,4y,Rf,26A69A,B,C,,.YPCD,CD,0,0,0,0,,C,D,,...N_e',
  // <generated by `npm run template-payloads` — do not edit by hand>
  Whitworth_Quick_Return:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.0B,B,0,ku,0.4C,C,Fe,0,0.0D,D,095,1A7,0.1P,P,0,ku,0,CD,C,D..YRAB,AB,0,0,0,NS,303e9f,A,B,,.YRCD,CD,0,0,3H,b4,0d125a,C,D,,.YPBP,BP,0,0,0,0,,B,P,,...N_r',
  Scotch_Yoke:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.0B,B,Fe,0,0.8C,C,Fe,0VG,0.0D,D,Fe,S8,0.1E,E,Fe,0,0,CD,C,D.5F,F,Fe,0VG,0..YRAB,AB,0,0,7q,0,303e9f,A,B,,.YRCD,CD,0,0,Fe,01a,26A69A,C,D,,.YPBE,BE,0,0,0,0,,B,E,,.YPCF,CF,0,0,0,0,,C,F,,...N_T',
  Cylinder_Boom:
    '2v.Ay,Fe.5,0.1011.4O,O,0,0,0.0C,C,0,_W,0.4G,G,ku,0,0.0N,N,Ju,Z-,0.8P,P,R0,QX,0.ZS,S,R0,QX,0,GN,G,N..YROC,OC,0,0,0,VG,303e9f,O,C,,.YRGN,GN,0,0,XO,I0,0d125a,G,N,,.YRPC,PC,0,0,DW,iW,26A69A,P,C,,.YPPS,PS,0,0,0,0,,P,S,,...N_X',
  Cylinder_Gripper:
    '2v.Ay,1E8.5,0.1011.0A,A,0,0,0.4B,B,bW,ee,0.4C,C,11e,ee,0.0D,D,mS,Li,0.0E,E,1Ca,Li,0.0F,F,1rC,Li,0.4G,G,bW,0ee,0.4H,H,11e,0ee,0.0I,I,mS,0Li,0.0J,J,1Ca,0Li,0.0K,K,1rC,0Li,0.7L,L,0,0,0..YRBD,Hanger,0,0,g_,VA,303e9f,B,D,,.YRCE,Hanger,0,0,176,VA,0d125a,C,E,,.YRDEF,Jaw,0,0,1Gl,Li,26A69A,D,E,F,,.YRAD,AD,0,0,OE,As,00695C,A,D,,.YRGI,Hanger,0,0,g_,0VA,303e9f,G,I,,.YRHJ,Hanger,0,0,176,0VA,0d125a,H,J,,.YRIJK,Jaw,0,0,1Gl,0Li,26A69A,I,J,K,,.YRAI,AI,0,0,OE,0As,00695C,A,I,,.YPAL,AL,0,0,0,0,,A,L,,...N_u',
  Radial_Engine:
  ...
  Chebyshev_Straight_Line:
    '2v.Ay,1E8.3,0.1011.6G,G,0VG,0,0.0A,A,0Fe,_W,0.0B,B,Fe,_W,0.GM,M,0,_W,0.4H,H,VG,0,0..YRGB,GB,0,0,07q,VG,303e9f,G,B,,.YRABM,ABM,0,0,0,_W,26A69A,A,B,M,,.YRAH,AH,0,0,7q,VG,0d125a,A,H,,...N_z',
  Windshield_Wiper:
  ...
  Elliptical_Crank:
    '2v.Ay,1E8.A,0.1011.6A,A,0ix,X,0.0B,B,0zu,7O,0.0C,C,0qC,Lr,0.GD,D,085,Av,0.0E,E,aY,v,0.4F,F,0,0,0.5P,P,aY,v,03..YRAB,AB,0,0,0rQ,3y,303e9f,A,B,,.YRBC,BC,0,0,0v2,Ed,26A69A,B,C,,.YRCDE,CDE,0,0,07x,BD,00695C,C,D,E,,.YRDF,DF,0,0,043,5S,0d125a,D,F,,.YPEP,EP,0,0,0,0,,E,P,,...N_M',
  Jansen_Leg:
  ...
  Shaper_Quick_Return:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.0B,B,Fe,0,0.4C,C,0,0ku,0.0D,D,Oj,RF,0.0R,R,qW,si,0.1P,P,Fe,0,0,CD,C,D.5Q,Q,qW,si,0..YRAB,AB,0,0,7q,0,303e9f,A,B,,.YRCD,CD,0,0,CN,09q,0d125a,C,D,,.YRDR,DR,0,0,cd,e_,26A69A,D,R,,.YPBP,BP,0,0,0,0,,B,P,,.YPRQ,RQ,0,0,0,0,,R,Q,,...N_9',
  Pedaling_Leg:
    '2v.Ay,1E8.4,0.1011.4B,B,0,0,0.GP,P,Qa,0,0.4H,H,0NS,1Qe,0.2K,K,c5,13o,0..YRHK,HK,0,0,7L,1FD,303e9f,H,K,,.YRKP,KP,0,0,WL,Xv,26A69A,K,P,,.YRBP,BP,0,0,DI,0,0d125a,B,P,,...N_j',
  Oscillating_Fan:
    '2v.Ay,1E8.A,0.1011.4A,A,0,0,0.2C,C,s8,0VG,0.0D,D,k_,0j9,0.4B,B,0GY,0In,0.0N,N,1NW,0,0..YRACN,ACN,0,0,lD,0AR,303e9f,A,C,N,,.YRCD,CD,0,0,oZ,0cC,26A69A,C,D,,.YRDB,DB,0,0,FE,0Vz,0d125a,D,B,,...N_5',
  Pumpjack:
    '2v.Ay,1E8.3,0.1011.4A,A,0gB,0oI,0.0M,M,0QZ,0o1,0.2P,P,0d4,0,0.4S,S,0,0,0.0H,H,o0,0,0.0R,R,r8,0eW,0.5W,W,r8,0eW,OZ..YRAM,AM,0,0,0YN,0oA,303e9f,A,M,,.YRMP,MP,0,0,0Wq,0P1,26A69A,M,P,,.YRPSH,PSH,0,0,3f,0,0d125a,P,S,H,,.YRHR,HR,0,0,pa,0KG,00695C,H,R,,.YPRW,RW,0,0,0,0,,R,W,,...N_Q',
  Punch_Press:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.0B,B,0,Im,0.0C,C,0,0r8,0.5P,P,0,0r8,OZ..ARAB,Crank,mr0,1E8,0,9O,303e9f,A,B,,.MRBC,Connecting rod,19FW,9n0,0,06Q,26A69A,B,C,,.YPCP,CP,2IV0,0,0,0,,C,P,,..2F1,BC,F1,0,0r8,0,0bW,_W..N_O',
  Derrick_Crane:
    '2v.Ay,1E8.A,0.1011.4O,O,0,0,0.0C,C,Qv,cP,0.0T,T,rn,1Cp,0.6G,G,YO,09O,0.0K,K,Mp,18,0..ARGK,Luffing crank,mr0,1E8,Sc,048,303e9f,G,K,,.ARCK,Luffing link,19FW,9n0,Os,Jn,26A69A,C,K,,.MROCT,Boom,4a_0,19FW,LX,Uk,0d125a,O,C,T,,..2F1,OCT,F1,rn,1Cp,rn,zB,d4..N_3',
  Toggle_Clamp:
    '2v.Ay,1E8.A,0.1011.6H,H,0ee,Ti,0.0E,E,09O,NS,0.0P,P,P0,5U,0.4N,N,0Lu,09O,0..MRHE,Handle,adm,1E8,0Ti,RW,303e9f,H,E,,.AREP,Toggle link,OQW,1z0,7q,ET,26A69A,E,P,,.ARNP,Clamp bar,mr0,4uW,1a,01z,0d125a,N,P,,..2F1,NP,F1,P0,5U,P0,L6,S8..N_k',
  Offset_Load_Rocker:
    '2v.Ay,1E8.G,0.1011.6A,A,0,0,0.0B,B,HC,7q,0.0C,C,104,bW,0.4D,D,1E8,0,0.0L,L,1SC,jK,0..ARAB,Input lever,mr0,1E8,8c,3w,303e9f,A,B,,.ARBC,Coupler,1Xg0,CDG,ee,Mg,26A69A,B,C,,.ARCDL,Rocker,1w4W,L_G,1E8,Rd,0d125a,C,D,L,,..2F1,CDL,F1,1SC,jK,1Fi,Zy,NS..N_y',
  Drag_Link:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.0B,B,0,YO,0.0C,C,cU,LL,0.4D,D,Fe,0,0..YRAB,AB,0,0,0,HC,303e9f,A,B,,.YRBC,BC,0,0,JF,Rs,26A69A,B,C,,.YRCD,CD,0,0,R3,Ag,0d125a,C,D,,...N_e',
  Bell_Crank:
  ...
  Flywheel_Engine:
    '2v.Ay,1E8.5,0.1011.6A,A,0,0,0,,,,2SG.0B,B,Fe,0,0.0R,R,0Lu,0,0.0C,C,17u,0,0.5P,P,17u,0,0..0RABR,Flywheel,0,0,025,0,303e9f,A,B,R,,.YRBC,Connecting rod,0,0,hm,0,26A69A,B,C,,.YPCP,CP,0,0,0,0,,C,P,,...N_C',
  Screw_Jack:
    '2v.Ay,YO.5,0.1011.0A,A,0ID,0,0.0B,B,G4,FE,0.4C,C,0,YO,0.7P,P,0ID,0,0..YRAB,AB,0,0,014,7d,26A69A,A,B,,.YRBC,BC,0,0,82,Op,303e9f,B,C,,.YPAP,AP,0,0,0,0,,A,P,,...N_a',
  Elliptical_Trammel:
    '2v.Ay,Im.5,0.1011.0A,A,Fe,0,0.0B,B,0,Fe,0.0T,T,AR,5D,0.7C,C,Fe,0,0.5D,D,0,Fe,OZ..YRABT,ABT,0,0,8i,6y,26A69A,A,B,T,,.YPAC,AC,0,0,0,0,,A,C,,.YPBD,BD,0,0,0,0,,B,D,,...N_g',
  Peaucellier:
  ...
  Crane_Two_Loads:
    '2v.Ay,1E8.5,0.1011.4O,O,0,0,0.0C,C,W9,cJ,0.0T,T,16K,1Jo,0.6G,G,bW,0CW,0,,,,2Ce.0K,K,mB,_,0..ARGK,Luffing crank,mr0,1E8,gr,05n,303e9f,G,K,,.ARCK,Luffing link,19FW,9n0,eA,Jf,26A69A,C,K,,.YROCT,Jib,4a_0,19FW,E4,Gm,0d125a,O,C,T,,..2F1,OCT,F1,16K,1Jo,16K,14A,ee.3F2,OCT,F2,uG,132,kD,t4,S8..N_d',
  Locked_Four_Bar:
    '2v.Ay,1E8.5,0.1011.6A,A,0,0,0.0B,B,Nm,0,0.0C,C,126,lL,0.4D,D,17S,0,0.0E,E,1As,PW,0.0F,F,dq,Uc,0.0G,G,W5,tN,0.0H,H,Bu,G4,0.0I,I,11K,UW,0..YRABH,ABH,0,0,01Zi,bM,303e9f,A,B,H,,.YRBCFG,BCFG,0,0,jM2,p3C,26A69A,B,C,F,G,,.YRCDEI,CDEI,0,0,1pNm,0550,0d125a,C,D,E,I,,...N_.JB,JC,JD,JE,JF,JG,JIZ',
  Three_Machines:
