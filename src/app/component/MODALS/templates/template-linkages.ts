...
export const BUILT_IN_TEMPLATE_IDS = [
  ...
  'Stephenson_III',
  'Slider_Crank',
  // Hand-authored like the five above, and later: a four-bar whose bars each
  // hold a dimension, drawn in the app and pasted in as the URL it produced,
  // because holds are set by hand and no fixture writes them.
  'Locked_Four_Bar',
  // The gripper as its author drew it on 5 Sep 2026 -- the rails mechanism
  // the gallery's `slideGripperFixture` verifies, renamed, recolored and
  // carrying a load on each jaw. Kept as the string that was shared, since
  // the loads and the colors are choices no fixture regenerates.
  'Cylinder_Gripper',
  // Real-life use cases, drawn by hand over a picture of the machine on 7 Sep
  // 2026 and pasted in as the URLs the app produced. Each card ships the
  // picture it was traced over as its backdrop (template-catalog.ts).
...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  ...
  Watt_I:
    '2v.Fe,1E8.A,0.1011.6A,A,0Qh,0Kn,0.0B,B,0e1,9i,0.0C,C,bT,LF,0.0D,D,0G5,tZ,0.0E,E,V5,1_z,0.0F,F,1mM,1Gv,0.4G,G,1rt,0ey,0..YRAB,AB,0,0,0XM,05Z,303e9f,A,B,,.YRBCD,BCD,0,0,06D,Sr,26A69A,B,C,D,,.YRDE,DE,0,0,7W,1RG,00695C,D,E,,.YREF,EF,0,0,17j,1dx,26A69A,E,F,,.YRFCG,FCG,0,0,1PE,KQ,0d125a,F,C,G,,...N_k*4PeELI',
  Watt_II:
    '2v.Fe,1E8.A,0.1011.6A,A,0Vf,0Vd,0.0B,B,0mZ,08A,0.0C,C,06Y,LC,0.0D,D,1MR,J2,0.4E,E,rw,0j2,0.0F,F,2ic,ID,0.4G,G,2lk,0Zt,0..YRAB,AB,0,0,0e6,0Ju,303e9f,A,B,,.YRBC,BC,0,0,0RY,6X,26A69A,B,C,,.YRCDE,CDE,0,0,ic,01d,0d125a,C,D,E,,.YRDF,DF,0,0,21X,Id,00695C,D,F,,.YRFG,FG,0,0,2kA,08r,303e9f,F,G,,...N_h*2Gq2mt',
  Stephenson_III:
    '2v.Fe,1E8.A,0.1011.6A,A,0YP,0ce,0.0B,B,0cQ,0FI,0.0C,C,lC,1-,0.4D,D,ow,0U1,0.0E,E,033,D-,0.0F,F,Dc,nj,0.4G,G,1M0,GJ,0..YRAB,AB,0,0,0aP,0Qz,303e9f,A,B,,.YRBCE,BCE,0,0,1w,E,26A69A,B,C,E,,.YRCD,CD,0,0,n3,0E1,0d125a,C,D,,.YREF,EF,0,0,5H,Vs,00695C,E,F,,.YRFG,FG,0,0,np,X0,303e9f,F,G,,...N_Z*3arR39',
  Slider_Crank:
  ...
  Locked_Four_Bar:
    '2v.Eg,1E8.A,0.1011.6A,A,0cQ,0Pk,0.0B,B,4G,P6,0.0C,C,1Xh,Wq,0.4D,D,1tb,0Pk,0..MRAB,AB,0,0,0H5,0K,303e9f,A,B,,.MRBC,BC,0,0,o_,Sz,26A69A,B,C,,.MRCD,CD,0,0,1ie,3Z,0d125a,C,D,,...N_.HaAB,HlBC,HlCD5*4Xk8SF',
  Cylinder_Gripper:
    '2v.Ay,6G.5,0.1011.4A,A,01E8,0,0.0B,B,0w9,0,0.8C,C,0vV,0,0.0D,D,0bW,0,0.0G,G,0Fe,Fe,0.0H,H,Fe,Fe,0.0I,I,0Fe,0Fe,0.0J,J,Fe,0Fe,0.4K,K,0T4,xO,0.4L,L,0T4,0xO,0.4O,O,2C,xO,0.4P,P,2C,0xO,0.0M,M,0T4,XI,0.0Q,Q,2C,XI,0.0S,S,11U,Dc,0.0T,T,0T4,0XI,0.0V,V,2C,0XI,0.0X,X,11U,0Dc,0.ZE,E,0vV,0,0,AB,A,B.1N,N,0T4,XI,0,KL,K,L.1R,R,2C,XI,0,OP,O,P.1U,U,0T4,0XI,0,KL,K,L.1W,W,2C,0XI,0,OP,O,P..ARAB,Barrel,0,0,0148,0,00695C,A,B,,.ARCD,Rod,0,0,0lV,0,26A69A,C,D,,.MRDGHIJ,Carriage,0,0,07W,0,c5cae9,D,G,H,I,J,,.MRKL,Rail,0,0,0T4,0,0d125a,K,L,,.MROP,Rail,0,0,2C,0,0d125a,O,P,,.MRGM,GM,0,0,0MM,OT,B2DFDB,G,M,,.MRHQ,HQ,0,0,8w,OT,B2DFDB,H,Q,,.MRMQS,Jaw,0,0,Ct,Qk,00695C,M,Q,S,,.MRIT,IT,0,0,0MM,0OT,B2DFDB,I,T,,.MRJV,JV,0,0,8w,0OT,B2DFDB,J,V,,.MRTVX,Jaw,0,0,Ct,0Qk,00695C,T,V,X,,.YPCE,CE,0,0,0,0,,C,E,,.YPMN,MN,0,0,0,0,,M,N,,.YPQR,QR,0,0,0,0,,Q,R,,.YPTU,TU,0,0,0,0,,T,U,,.YPVW,VW,0,0,0,0,,V,W,,..2F1,MQS,F1,11U,Dc,11U,cx,Fe.2F2,TVX,F2,11U,0Dc,11m,0h6,Fe..N_.KFF1~303e9f,KFF2~303e9fM*1NvmfZ',
  Aircraft_Landing_Gear:
    '2u.7S,38.5,0.1011.4A,A,1Lu,1Cf,0.OB,B,1N1,Kp,0.0E,E,10g,1F6,0.0G,G,19p,_1,0.0H,H,1MN,ug,0.4I,I,1MG,1Hx,0.0I1,I1,16T,1Ft,0.8I2,I2,1GT,1HA,0.ZI3,I3,1GT,1HA,0,II1,I,I1,38.CJ,J,rR,17h,0.8K,K,1BI,KU,0.0L,L,1BO,4E,0.0M,M,1Ih,4G,0.0N,N,1ID,Vb,0.0O,O,1BJ,VJ,0.0P,P,1F4,XA,0.0Q,Q,1Eg,2q,0..ARHG,HG,0,0,1G5,xM,26A69A,H,G,,.ARII1,II1,0,0,1EN,1Gv,00695C,I,I1,,.AREI2,EI2,0,0,18Z,1G8,c5cae9,I2,E,,.YPI2I3,I2I3,0,0,0,0,,I2,I3,,.AREGJ,EGJ,0,0,zL,177,303e9f,E,J,G,,EJ,JG.ARABHKLMNOPQ,ABHKLMNOPQ,0,0,1IA,Tx,0d125a,A,B,H,K,L,M,N,O,P,Q,,ABH,BK,KLMNOPQ.aREJ,EJ,0,0,x3,1BP,B2DFDB,E,J,,.aRJG,JG,0,0,-d,12s,26A69A,J,G,,.aRABH,ABH,0,0,1MR,pN,0d125a,A,B,H,,.aRBK,BK,0,0,1HA,Kf,c5cae9,B,K,,.aRKLMNOPQ,KLMNOPQ,0,0,1EN,IH,303e9f,K,L,M,N,O,P,Q,,...N_d*4a5AYE',
  Hood_Hinge:
    '2u.7q,1a.5,0.1011.4A,A,2C,o,0.0A1,A1,ZP,U,0.8A2,A2,Nc,b,0.0B,B,up,H,0.ZA3,A3,Nc,b,0,AA1,A,A1,1a.4E,E,Vf,8j,0.0F,F,2m,M-,0.GG,G,Zy,Im,0.0H,H,hm,6G,0.0I,I,1XI,Wy,0.KJ,J,q0,Cg,0.0K,K,vq,gB,0.8L,L,Ph,m_,0.8M,M,09E,pW,0.8N,N,0fg,nH,0.GO,O,0165,gD,0..ARAA1,AA1,0,0,Io,e,00695C,A,A1,,.ARA2B,A2B,0,0,eD,R,303e9f,A2,B,,.YPA2A3,A2A3,0,0,0,0,,A2,A3,,.AREFG,EFG,0,0,NS,Gq,0d125a,E,F,G,,.ARGH,GH,0,0,ds,CW,26A69A,G,H,,.ARBHIJ,BHIJ,0,0,11i,Dp,303e9f,H,I,B,J,,.ARFK,FK,0,0,UI,Wb,303e9f,F,K,,.ARIKLMNO,Hood,0,0,03D,kx,0d125a,K,I,L,M,N,O,,KIL,LM,MN,NO.aRKIL,KIL,0,0,yG,fN,0d125a,K,I,L,,.aRLM,LM,0,0,8F,oF,c5cae9,L,M,,.aRMN,MN,0,0,0PS,oP,303e9f,M,N,,.aRNO,NO,0,0,0tt,jl,c5cae9,N,O,,...N_n*3vxoD8',
  Excavator_Bucket:
    '2v.4i,Fe.5,0.1011.4A,A,0Mi,Nd,0.0B,B,Gd,0FP,0.0C,C,o,d,0.0D,D,E5,5C,0.0A1,A1,1r,BL,0.8A2,A2,0AS,HU,0.ZA3,A3,0AS,HU,0,AA1,A,A1,0Fe.0E,E,NC,08I,0.KH,H,0Wk,RB,0.8I,I,VG,0NS,0.GJ,J,KK,0YO,0.8K,K,WM,0FQ,0.0L,L,6U,4m,0..ARABCH,ABCH,0,0,0CT,BQ,0d125a,A,B,C,H,,.ARCDL,CD,0,0,77,3X,c5cae9,C,D,L,,.ARAA1,AA1,0,0,0AS,HU,26A69A,A,A1,,.ARA2D,A2D,0,0,1r,BL,00695C,A2,D,,.YPA2A3,A2A3,0,0,0,0,,A2,A3,,.ARDE,DE,0,0,If,01Z,0d125a,D,E,,.ARBEIJK,BEIJK,1w4W,28,RD,0KT,26A69A,I,J,B,E,K,,IJ,BEK,KI.aRIJ,IJ,eiB,0,Po,0Sw,00695C,I,J,,.aRBEK,BEK,eiB,0,O3,0D2,B2DFDB,B,E,K,,.aRKI,KI,eiB,0,Vp,0JR,c5cae9,K,I,,...N_R*3rBBwf',
  Car_Steering:
  ...
  Mechanical_Clock:
    '2v.Ay,1E8.y,0.1011.6A,A,0,0,0,,,,0EfW.0B,B,0,1E8,0.4C,C,ku,0,0.0D,D,ku,0Im,0.4E,E,0,0,0.0F,F,0,r8,0..YRAB,Minute hand,0,0,0,d4,303e9f,A,B,,.YRCD,Intermediate shaft,0,0,ku,09O,c5cae9,C,D,,.YREF,Hour hand,0,0,0,Qa,00695C,E,F,,...N_.G1~*3mseMf',
  Compound_Gear_Train:
    '2v.Ay,1E8.U,0.1011.6A,A,0ku,0,0.0B,B,0d4,0,0.4C,C,0,0,0.0D,D,Fe,0,0.4E,E,VG,0,0.0F,F,d4,DY,0.0G,G,1BQ,h9,0.4H,H,1Tm,0,0..YRAB,AB,0,0,0g_,0,303e9f,A,B,,.YRCD,CD,0,0,7q,0,0d125a,C,D,,.YREF,EF,0,0,ZA,6n,303e9f,E,F,,.YRFG,FG,0,0,vF,SL,26A69A,F,G,,.YRGH,GH,0,0,1Kb,La,0d125a,G,H,,...N_.G1~*2O6Ikr',
  Simple_Gear_Pair:
    '2v.Ay,1E8.U,0.1011.6A,A,0ku,0,0.0B,B,0d4,0,0.4C,C,0,0,0.0D,D,7q,DY,0..YRAB,AB,0,0,0g_,0,303e9f,A,B,,.YRCD,CD,0,0,3w,6n,0d125a,C,D,,...N_.G1~*4Ky8Mm',
  Gear_Driven_Four_Bar:
    '2v.Ay,1E8.U,0.1011.6A,A,0ku,0,0.0B,B,0d4,0,0.4C,C,0,0,0.0D,D,7q,DY,0.0E,E,iA,h9,0.4F,F,_W,0,0..YRAB,AB,0,0,0g_,0,303e9f,A,B,,.YRCD,CD,0,0,3w,6n,0d125a,C,D,,.YRDE,DE,0,0,P-,SL,26A69A,D,E,,.YREF,EF,0,0,rL,La,303e9f,E,F,,...N_.G1~*1KJ4WH',
  Idler_Gear_Train:
    '2v.Ay,1E8.U,0.1011.6A,A,0ku,0,0.0B,B,0d4,0,0.4C,C,0,0,0.0D,D,Fe,0,0.4E,E,ku,0,0.0F,F,_W,0,0..YRAB,AB,0,0,0g_,0,303e9f,A,B,,.YRCD,CD,0,0,7q,0,0d125a,C,D,,.YREF,EF,0,0,si,0,303e9f,E,F,,...N_.G1~*2SBNOM',
  Whitworth_Quick_Return:
  ...
  Chebyshev_Straight_Line:
    '2v.Ay,1E8.3,0.1011.6G,G,0VG,0,0.0A,A,0Fe,_W,0.0B,B,Fe,_W,0.GM,M,0,_W,0.4H,H,VG,0,0..YRGB,GB,0,0,07q,VG,303e9f,G,B,,.YRABM,ABM,0,0,0,_W,26A69A,A,B,M,,.YRAH,AH,0,0,7q,VG,0d125a,A,H,,...N_z*1uO2KK',
  Windshield_Wiper:
    '2v.Ay,1E8.A,0.1011.6O,O,0si,0iC,0.0A,A,0se,0Km,0.0B,B,Dl,0S4,0.4P,P,0,0,0.0C,C,AJ,0L3,0.GT,T,0YM,16B,0.0D,D,1e3,0L3,0.4Q,Q,1Tm,0,0.GU,U,xQ,16B,0..YROA,Motor crank,0,0,0sg,0WU,303e9f,O,A,,.YRAB,Drive link,0,0,0KS,0OQ,26A69A,A,B,,.YRBCPT,Wiper arm,0,0,02b,5H,0d125a,B,C,P,T,,.YRCD,Tie rod,0,0,vB,0L3,00695C,C,D,,.YRDQU,Passenger arm,0,0,1Ll,GO,0d125a,D,Q,U,,...N_p*38jjBo',
  Elliptical_Crank:
  ...
  Jansen_Leg:
    '2v.1jO,1E8.8,0.1011.6O,O,0,0,0.0A,A,3gO,0,0.4G,G,09Hm,01vu,0.0B,B,05tE,7ee,0.0C,C,0IGg,1-F,0.0D,D,06b8,0B7B,0.0E,E,0ETW,06sL,0.GF,F,0AYO,0MPj,0..YROA,OA,0,0,1rC,0,303e9f,O,A,,.YRAB,AB,0,0,016R,3qK,26A69A,A,B,,.YRGBC,GBC,0,0,0B8Z,2ag,0d125a,G,B,C,,.YRAD,AD,0,0,01TO,05Zc,00695C,A,D,,.YRGD,GD,0,0,07xS,06WY,303e9f,G,D,,.YRCE,CE,0,0,0GN5,02RZ,B2DFDB,C,E,,.YRDEF,DEF,0,0,0AXh,0DT4,26A69A,D,E,F,,...N_O*3MdpHm',
  Backhoe_Bucket:
  ...
  Pedaling_Leg:
    '2v.Ay,1E8.4,0.1011.4B,B,0,0,0.GP,P,Qa,0,0.4H,H,0NS,1Qe,0.2K,K,c5,13o,0..YRHK,HK,0,0,7L,1FD,303e9f,H,K,,.YRKP,KP,0,0,WL,Xv,26A69A,K,P,,.YRBP,BP,0,0,DI,0,0d125a,B,P,,...N_j*3rFbDy',
  Oscillating_Fan:
    '2v.Ay,1E8.A,0.1011.4A,A,0,0,0.2C,C,s8,0VG,0.0D,D,k_,0j9,0.4B,B,0GY,0In,0.0N,N,1NW,0,0..YRACN,ACN,0,0,lD,0AR,303e9f,A,C,N,,.YRCD,CD,0,0,oZ,0cC,26A69A,C,D,,.YRDB,DB,0,0,FE,0Vz,0d125a,D,B,,...N_5*2D8jGS',
  Pumpjack:
  ...
  Toggle_Clamp:
    '2v.Ay,1E8.A,0.1011.6H,H,0ee,Ti,0.0E,E,09O,NS,0.0P,P,P0,5U,0.4N,N,0Lu,09O,0..MRHE,Handle,adm,1E8,0Ti,RW,303e9f,H,E,,.AREP,Toggle link,OQW,1z0,7q,ET,26A69A,E,P,,.ARNP,Clamp bar,mr0,4uW,1a,01z,0d125a,N,P,,..2F1,NP,F1,P0,5U,P0,L6,S8..N_k*48qcHZ',
  Offset_Load_Rocker:
    '2v.Ay,1E8.G,0.1011.6A,A,0,0,0.0B,B,HC,7q,0.0C,C,104,bW,0.4D,D,1E8,0,0.0L,L,1SC,jK,0..ARAB,Input lever,mr0,1E8,8c,3w,303e9f,A,B,,.ARBC,Coupler,1Xg0,CDG,ee,Mg,26A69A,B,C,,.ARCDL,Rocker,1w4W,L_G,1E8,Rd,0d125a,C,D,L,,..2F1,CDL,F1,1SC,jK,1Fi,Zy,NS..N_y*3bHz6R',
  Bell_Crank:
  ...
  Peaucellier:
    '2v.Ay,1E8.A,0.1011.4O,O,0,0,0.6C,C,VG,0,0.0P,P,ku,R4,0.0A,A,g5,11r,0.0B,B,1E3,3X,0.GQ,Q,19G,gI,0..YRCP,CP,0,0,d4,DY,303e9f,C,P,,.YROA,OA,0,0,L2,Wx,0d125a,O,A,,.YROB,OB,0,0,d1,1n,0d125a,O,B,,.YRAP,AP,0,0,iU,kT,26A69A,A,P,,.YRBP,BP,0,0,_T,FJ,26A69A,B,P,,.YRAQ,AQ,0,0,vg,s4,00695C,A,Q,,.YRBQ,BQ,0,0,1Bf,Mw,00695C,B,Q,,...N_A*13TdMi',
  Pantograph:
    '2v.Ay,1E8.A,0.1011.6G,G,0,0,0.4H,H,_W,0,0.0R,R,0,Im,0.0S,S,pP,bT,0.GT,T,Ib,lh,0.4O,O,01E8,VG,0.0J,J,0ku,1jO,0.0K,K,0_W,16K,0.0L,L,0EA,1EY,0.GP,P,0To,dU,0..YRGR,GR,0,0,0,9O,303e9f,G,R,,.YRRST,RST,0,0,NL,Ye,26A69A,R,S,T,,.YRHS,HS,0,0,uz,Ik,0d125a,H,S,,.YRJKO,JKO,0,0,0_W,16K,303e9f,J,K,O,,.YRJLT,JLT,0,0,0EA,1EY,00695C,J,L,T,,.YRKP,KP,0,0,0k9,sv,00695C,K,P,,.YRLP,LP,0,0,0L_,x0,303e9f,L,P,,...N_L*2q1BJY',
  Double_Butterfly:
    '2v.Ay,1E8.A,0.1011.6A,A,0,0,0.4B,B,1WQ,0,0.0C,C,03I,UK,0.0D,D,Lu,7W,0.0E,E,g2,qg,0.0F,F,1RG,nY,0.0G,G,1Jw,SS,0.0H,H,uk,G6,0.0I,I,18_,0H2,0.0J,J,10Y,W2,0..YRACD,ACD,0,0,6D,Cd,303e9f,A,C,D,,.YRCE,CE,0,0,JO,fV,26A69A,C,E,,.YREFG,EFG,0,0,18P,hZ,00695C,E,F,G,,.YRBFJ,BFJ,0,0,1K4,RC,0d125a,B,F,J,,.YRDHI,DHI,0,0,oX,2C,26A69A,D,H,I,,.YRGH,GH,0,0,16K,MH,B2DFDB,G,H,,.YRIJ,IJ,0,0,14m,7W,00695C,I,J,,...N_N*1WvKbo',
  Crane_Two_Loads:
    '2v.Ay,1E8.5,0.1011.4O,O,0,0,0.0C,C,W9,cJ,0.0T,T,16K,1Jo,0.6G,G,bW,0CW,0,,,,2Ce.0K,K,mB,_,0..ARGK,Luffing crank,mr0,1E8,gr,05n,303e9f,G,K,,.ARCK,Luffing link,19FW,9n0,eA,Jf,26A69A,C,K,,.YROCT,Jib,4a_0,19FW,E4,Gm,0d125a,O,C,T,,..2F1,OCT,F1,16K,1Jo,16K,14A,ee.3F2,OCT,F2,uG,132,kD,t4,S8..N_d*09uswV',
  Three_Machines:
