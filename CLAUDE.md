...
- **How It Works** opens from the top-right toolbar in analysis modes: drawer 8 is the kinematic worksheet, and drawer 9 is the force worksheet. Graphs remain in the left panel. Force definitions are mechanism-independent; Free Bodies owns sign/reference controls and numbered equations; System shows known values, the numbered equations, and their matrix. See `docs/solver-explanations.md`.
